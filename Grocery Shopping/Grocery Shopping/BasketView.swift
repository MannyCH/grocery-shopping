...
struct BasketView: View {
    ...
    let sampleProducts: [Product] = [
        ...
        Product(productId: "104041100042", name: "Garlic Butter", brand: "Migros", productInformation: "150g für eine Packung von diesem Produkt", price: 3.90, originalPrice: nil, insteadOf: nil, imageUrl: nil, ratingAverage: 4.3, ratingCount: 29, availability: "available", energyBadgeUrl: nil, energyBadgeAltText: nil, hasDiscount: false, discountAmount: nil, discountDescription: nil, cumulusPoints: nil, badgeDescription: nil, minimumPieces: nil, discountPrice: nil, reductionTypeId: nil, reductionAmount: nil, reductionSuffix: nil), category: .dairyAndEggs, category: .condimentsAndCanned
    ]
